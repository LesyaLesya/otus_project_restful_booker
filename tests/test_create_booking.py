...
def test_post_firstname_positive(booker_api, param):
    ...
    data = body_id_data.TestDictForRequests().return_dict_with_firstname(param)

    with allure.step(f"Отправляем post запрос с firstname - '{param}'"):
        response = booker_api.post(data=json.dumps(data))
...
def test_post_firstname_negative(booker_api, param):
    """Тестовая функция для проверки вызова post запроса.
...
def test_post_lastname(booker_api, param):
    """Тестовая функция для проверки вызова post запроса.
    ...
    """
    data = body_id_data.TestDictForRequests().return_dict_with_lastname(param)
...
def test_post_totalprice(booker_api, param):
    """Тестовая функция для проверки вызова post запроса.
    ...
    """
    data = body_id_data.TestDictForRequests().return_dict_with_totalprice(param)
...
def test_post_depositpaid(booker_api, param):
    """Тестовая функция для проверки вызова post запроса.
    ...
    """
    data = body_id_data.TestDictForRequests().return_dict_with_depositpaid(param)
...
def test_post_checkin_positive(booker_api, param):
    """Тестовая функция для проверки вызова post запроса.
    ...
    """
    data = body_id_data.TestDictForRequests().return_dict_with_chekin(param)
...
def test_post_checkin_negative(booker_api, param):
    """Тестовая функция для проверки вызова post запроса.
...
def test_post_checkout(booker_api, param):
    """Тестовая функция для проверки вызова post запроса.
    ...
    """
    data = body_id_data.TestDictForRequests().return_dict_with_chekout(param)
...
def test_post_additionalneeds(booker_api, param):
    """Тестовая функция для проверки вызова post запроса.
    ...
    """
    data = body_id_data.TestDictForRequests().return_dict_with_addneeds(param)
...
@pytest.mark.negative
def test_post_empty_body(booker_api):
    """Тестовая функция для проверки вызова post запроса.
