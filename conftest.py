...
def check_200_status_code() -> str:
    """Возвращает строку с указанием кода ответа."""
...
def fixture_check_200_status_code() -> str:
    """Фикстура, вызывающая функцию и возвращающая строку с кодом ответа 200."""
    return check_200_status_code()


@pytest.fixture
def fixture_check_500_status_code() -> str:
    """Фикстура, вызывающая функцию и возвращающая строку с кодом ответа 500."""
    return check_500_status_code()


@pytest.fixture
def fixture_check_405_status_code() -> str:
    """Фикстура, вызывающая функцию и возвращающая строку с кодом ответа 405."""
